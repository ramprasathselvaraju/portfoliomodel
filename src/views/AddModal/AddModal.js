...
export default function AddModal(props) {
  ...
  const [addSecurity, setaddSecurity] = useState("INDUSNDBK");
  const [NTPC, setNTPC] = useState(0);
  const [HDFCBANK, setHDFCBANK] = useState(0);
  const [Maruti, setMaruti] = useState(0);
                            ...
                            if(rowData.id == 3){
                              ...
                              return (
                                <Form.Control
                                  ...
                                  autoComplete="off"
                                  value={Number(Number(assetdata[0] + assetdata[1] + assetdata[2]))}
                                />
                              );
                            }
                            else{
